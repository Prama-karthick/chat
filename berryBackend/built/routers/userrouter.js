...
router.post("/register", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, phone_number, gender, user, newuser, Ur;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, email = _a.email, password = _a.password, phone_number = _a.phone_number, gender = _a.gender;
            ...
            case 2:
                ...
                return [4 /*yield*/, userModel_1.UserModel.create(newuser)];
            case 3:
                Ur = _b.sent();
                res.send(Ur);
                _b.label = 4;
